...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [self.window setTintColor:[UIColor colorWithRed:52/255.f green:152/255.f blue:219/255.f alpha:1]];
    ...
    //[navController addClassOfTransparentViewController:[ThirdTableViewController class]];
